    ...
    return (
        <div className={style.containerAbout}>
            ...
            <div className={style.sobre}>
                <h2>Sobre la web:</h2>
                <p>Esta aplicación web permite buscar gifs por texto y se mostrarán 10 gifs en pantalla. Añádí un loading al buscar los gifs y también para la carga de los propios gifs.</p>
                <h2>Sobre mi:</h2>
